...
?>
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Insert Ticket
...
<?php
		...
		// Check if image file is a act
			...
			if($check !== false) {
				echo " uploaded- " . $check["mime"] . "."; echo '</br>';
				$uploadOk = 1;
			} else {
	...
	$sql = "INSERT INTO ticket "."VALUES('$ticket_no', '$plugin', '$post_date', '$developer', '$count', '$issue', '$p_id', '$agent_id','$profileImage')";
	
	if ($conn->query($sql) === true) {
			echo "New Ticket Added";  echo '</br>';
		} else {
		...
		/// Developer BEING ADDED
   $sql = "INSERT INTO developer "."VALUES('$developer_id', '$ticket_no', '$name')";
	
	if ($conn->query($sql) === true) {
			echo "developer ADDED";  echo '</br>';
		} else {
			echo "Error: " . $sql . "<br>" . $conn->error;  echo '</br>';
		}
